...
class leg(models.Model):
    ...
    total_price=models.FloatField(default=10246)
...
class leg1(models.Model):
    leg_id=models.OneToOneField(leg,on_delete=models.CASCADE)
...
class comment(models.Model):
    ...
    date_time=models.DateTimeField(default="2020-01-01 12:00:00")
...
class price(models.Model):
    flight_leg=models.ForeignKey(leg,on_delete=models.CASCADE)
    price=models.FloatField()
    miles=models.IntegerField(default=10000)
